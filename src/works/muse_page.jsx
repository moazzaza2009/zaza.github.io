    ...
    return (
        <div className="Stag_page">
            <section className="Stag_sections">
                <img src="/assets/muse_logo/muse6.png" className="Stag1" alt="Stag Logo 1" />
            </section>

            <section className="Stag_sections">
                <div className="text1_c">
                    <div className="flex">
                        <p className="text_stag1">We make a magic in shoes </p>
                    </div>
                    <div>
                        <p className="text_stag2">CLIENT</p>
                        <p className="text_stag3">Muse</p>
                    </div>
                    <div className="text_stag4c">
                        <p className="text_stag4">
                            A shop that sells shoes. their main product stands out because of its superior quality.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <div className="images">
                <motion.div className="flex gap-2" style={{ x: smoothX }}>
                    <img src="/assets/muse_logo/muse2.png" alt="muse 2" />
                    <img src="/assets/muse_logo/muse3.png" alt="muse 3" />
                    <img src="/assets/muse_logo/muse5.jpg" alt="muse 5" />
                </motion.div>
            ...
            <section className="goal_section">
                ...
                <div className="goal1">
                    <p className="goal1">Our goal is to make the best shoes that you will really love.</p>
                </div>
            </section>

            <section className="Stagcc" ref={stagccRef}>
                <img src="/assets/muse_logo/muse3.png" alt="Stag 3" />
                <img src="/assets/muse_logo/muse5.jpg" alt="Stag 5" />
                <img src="/assets/muse_logo/muse7.png" alt="Stag 7" />
                <img src="/assets/muse_logo/muse2.png" alt="Stag 2" />
                <img src="/assets/muse_logo/muse4.png" alt="Stag 4" />
                ...
                >
                    ...
                    <img
                        src="/assets/DBMS_logo/DBMS111.png"
                        alt="Stag 11"
