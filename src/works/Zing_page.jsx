    ...
    return (
        <div className="Stag_page">
            <section className="Stag_sections">
                <img src="/assets/Zing_logo/Zing1.png" className="Stag1" alt="Stag Logo 1" />
            </section>

            <section className="Stag_sections">
                <div className="text1_c">
                    <div className="flex">
                        <p className="text_stag1">We have the comedy</p>
                    </div>
                    <div>
                        <p className="text_stag2">CLIENT</p>
                        <p className="text_stag3">Stag</p>
                    </div>
                    <div className="text_stag4c">
                        <p className="text_stag4">
                            A company that makes and distributes comedy movies.They stand out because they are cheap and available in your local shops.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <div className="images">
                <motion.div className="flex gap-2" style={{ x: smoothX }}>
                    <img src="/assets/Zing_logo/Zing2.png" alt="Stag 2" />
                    <img src="/assets/Zing_logo/Zing3.png" alt="Stag 3" />
                    <img src="/assets/Zing_logo/Zing4.png" alt="Stag 4" />
                    <img src="/assets/Zing_logo/Zing5.png" alt="Stag 5" />
                </motion.div>

                <motion.div className="flex gap-2" style={{ x: smoothXX }}>
                    <img src="/assets/Zing_logo/Zing6.png" alt="Stag 6" />
                    <img src="/assets/Zing_logo/Zing7.png" alt="Stag 7" />
                    <img src="/assets/Zing_logo/Zing8.png" alt="Stag 8" />
                </motion.div>
            </div>
            ...
            <section className="goal_section">
                ...
                <div className="goal1">
                    <p className="goal1">Our goal is to make you laugh from your heart.</p>
                </div>
            </section>
            ...
            <section className="Stagcc" ref={stagccRef}>
                ...
                >
                    ...
                    <img
                        src="assets/Mountain_logo/M11.png"
                        alt="Stag 11"
