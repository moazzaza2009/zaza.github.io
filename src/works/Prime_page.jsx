    ...
    return (
        <div className="Stag_page">
            <section className="Stag_sections">
                <img src="/assets/Prime_logo/Prime1.png" className="Stag1" alt="Stag Logo 1" />
            </section>

            <section className="Stag_sections">
                <div className="text1_c">
                    <div className="flex">
                        <p className="text_stag1">We know what is movies</p>
                    </div>
                    <div>
                        <p className="text_stag2">CLIENT</p>
                        <p className="text_stag3">Prime</p>
                    </div>
                    <div className="text_stag4c">
                        <p className="text_stag4">
                            A company that makes and distributes movies . They stand out because they are produced by big names in the industry and available in stores worldwide.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <div className="images">
                <motion.div className="flex gap-2" style={{ x: smoothX }}>
                    <img src="/assets/Prime_logo/Prime2.png" alt="Stag 2" />
                    <img src="/assets/Prime_logo/Prime3.png" alt="Stag 3" />
                    <img src="/assets/Prime_logo/Prime4.png" alt="Stag 4" />
                    <img src="/assets/Prime_logo/Prime5.png" alt="Stag 5" />
                </motion.div>
            ...
            <section className="goal_section">
                ...
                <div className="goal1">
                    <p className="goal1">Our goal is to make the best movies for you .</p>
                </div>
            </section>
            ...
            <section className="Stagcc" ref={stagccRef}>
                <img src="/assets/Prime_logo/Prime3.png" alt="Stag 3" />
                <img src="/assets/Prime_logo/Prime5.png" alt="Stag 5" />
                <img src="/assets/Prime_logo/Prime6.png" alt="Stag 6" />
                <img src="/assets/Prime_logo/Prime7.png" alt="Stag 7" />
                <img src="/assets/Prime_logo/Prime2.png" alt="Stag 2" />
                <img src="/assets/Prime_logo/Prime4.png" alt="Stag 4" />
